...
# The validation body is assigned to $ValidationScript as a real scriptblock literal;
# the upload body invokes it after the SAS URL is substituted. SAS URLs are URL-safe
# (no single quotes), so direct substitution is safe.
